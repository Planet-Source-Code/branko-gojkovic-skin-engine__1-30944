...
Public Sub LoadSkin(F As Form, Stanje As eStanje, PrviPut As Boolean, Optional ByVal Pozadina As Integer)
    ...
    If Pozadina = 1 And PrviPut = True Then StretchBlt F.hdc, L.Width, TL.Height, äirina, Visina, SourceHdc, mBack.X, mBack.Y, mBack.Width, mBack.Height, vbSrcCopy
     
    If Stanje = Aktivan Then
        
        'LeftCornerUp
        BitBlt F.hdc, uäirina, uVisina, LCUP.Width, LCUP.Height, SourceHdc, LCUP.X, LCUP.Y, vbSrcCopy
        uäirina = uäirina + LCUP.Width
        ...
        'TitleLeft
        BitBlt F.hdc, uäirina, 0, TL.Width, TL.Height, SourceHdc, TL.X, TL.Y, vbSrcCopy
            uäirina = uäirina + TL.Width
            TitleLeft = uäirina * Screen.TwipsPerPixelX
        ...
        'PozadinaNaslova
        If Title.Back = 1 Then StretchBlt F.hdc, uäirina, 0, TitleWidth, TitleBack.Height, SourceHdc, TitleBack.X, TitleBack.Y, TitleBack.Width, TitleBack.Height, vbSrcCopy
        uäirina = uäirina + TitleWidth
        'Kraj naslova
        BitBlt F.hdc, uäirina, 0, TitleBackEnd.Width, TitleBackEnd.Height, SourceHdc, TitleBackEnd.X, TitleBackEnd.Y, vbSrcCopy
        uäirina = uäirina + TitleBackEnd.Width
        'TitleBar
        StretchBlt F.hdc, uäirina, 0, äirina - uäirina, mTitle.Height, SourceHdc, mTitle.X, mTitle.Y, mTitle.Width, mTitle.Height, vbSrcCopy
        'Close
        BitBlt F.hdc, äirina - (mClose.Width + RightCUP.Width), 0, mClose.Width, mClose.Height, SourceHdc, mClose.X, mClose.Y, vbSrcCopy
        If PrviPut = True Then
            ...
            F!cmdClose.Top = 0
            F!cmdClose.Left = (äirina - (mClose.Width + RightCUP.Width)) * Screen.TwipsPerPixelX
        Else
            F!cmdClose.Ena
        End If
        
        'Desni gornji ugao
        BitBlt F.hdc, äirina - RightCUP.Width, 0, RightCUP.Width, RightCUP.Height, SourceHdc, RightCUP.X, RightCUP.Y, vbSrcCopy
        'Desna ivica
        StretchBlt F.hdc, äirina - mRight.Width, uVisina, mRight.Width, Visina - uVisina, SourceHdc, mRight.X, mRight.Y, mRight.Width, mRight.Height, vbSrcCopy
        'Donja linija
        StretchBlt F.hdc, LCD.Width, Visina - mBottom.Height, äirina - (LCD.Width + mRightCD.Width), mBottom.Height, SourceHdc, mBottom.X, mBottom.Y, mBottom.Width, mBottom.Height, vbSrcCopy
        'Donji Korner
        BitBlt F.hdc, äirina - mRightCD.Width, Visina - mRightCD.Height, mRightCD.Width, mRightCD.Height, SourceHdc, mRightCD.X, mRightCD.Y, vbSrcCopy
    Else
        'LeftCornerUp
        BitBlt F.hdc, uäirina, uVisina, LCUP.Width, LCUP.Height, SourceHdc, LCUP.X + LCUP.Width, LCUP.Y, vbSrcCopy
        uäirina = uäirina + LCUP.Width
        uVisina = uVisina + LCUP.Height
        ...
        'TitleLeft
        BitBlt F.hdc, uäirina, 0, TL.Width, TL.Height, SourceHdc, TL.X, TL.Y + TL.Height, vbSrcCopy
            uäirina = uäirina + TL.Width
            TitleLeft = uäirina * Screen.TwipsPerPixelX
            F!lbltitle.ForeColor = Title.ColorB
            TitleWidth = F!lbltitle.Width / Screen.TwipsPerPixelX
        'PozadinaNaslova
        If Title.Back = 1 Then StretchBlt F.hdc, uäirina, 0, TitleWidth, TitleBack.Height, SourceHdc, TitleBack.X, TitleBack.Y + TitleBack.Height, TitleBack.Width, TitleBack.Height, vbSrcCopy
        uäirina = uäirina + TitleWidth
        'Kraj naslova
        BitBlt F.hdc, uäirina, 0, TitleBackEnd.Width, TitleBackEnd.Height, SourceHdc, TitleBackEnd.X, TitleBackEnd.Y + TitleBackEnd.Height, vbSrcCopy
        uäirina = uäirina + TitleBackEnd.Width
        'TitleBar
        StretchBlt F.hdc, uäirina, 0, äirina - uäirina, mTitle.Height, SourceHdc, mTitle.X, mTitle.Y + mTitle.Height, mTitle.Width, mTitle.Height, vbSrcCopy
        'Close
        BitBlt F.hdc, äirina - (mClose.Width + RightCUP.Width), 0, mClose.Width, mClose.Height, SourceHdc, mClose.X, mClose.Y + mClose.Height, vbSrcCopy
        F!cmdClose.Dis
        'Desni gornji ugao
        BitBlt F.hdc, äirina - RightCUP.Width, 0, RightCUP.Width, RightCUP.Height, SourceHdc, RightCUP.X + RightCUP.Width, RightCUP.Y, vbSrcCopy
        'Desna ivica
        StretchBlt F.hdc, äirina - mRight.Width, uVisina, mRight.Width, Visina - uVisina, SourceHdc, mRight.X + mRight.Width, mRight.Y, mRight.Width, mRight.Height, vbSrcCopy
        'Donja linija
        StretchBlt F.hdc, LCD.Width, Visina - mBottom.Height, äirina - (LCD.Width + mRightCD.Width), mBottom.Height, SourceHdc, mBottom.X, mBottom.Y + mBottom.Height, mBottom.Width, mBottom.Height, vbSrcCopy
        'Donji Korner
        BitBlt F.hdc, äirina - mRightCD.Width, Visina - mRightCD.Height, mRightCD.Width, mRightCD.Height, SourceHdc, mRightCD.X + mRightCD.Width, mRightCD.Y, vbSrcCopy
