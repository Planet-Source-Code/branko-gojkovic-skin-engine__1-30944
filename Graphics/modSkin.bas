...
Public Sub GetSkinSettings5()
    ...
    'UËitavanje skin kljuËeva iz [skin].ini
...
End Function
    ...
    Dim DeskHdc As Long
    Dim i As Long
    Dim äirina As Integer
    Dim Visina As Integer
    Dim äirinaNaslova As Integer
    Dim uäirina As Integer
    ...
    äirina = F.Width / Screen.TwipsPerPixelX
    ...
    äirinaNaslova = F.lblTitle.Width / Screen.TwipsPerPixelX
    uäirina = 0
    uVisina = 0
    ...
    If mPozadina = Sa Then
        If mskinTitle.Back = 1 And mUslov = First Then
            If mskinTitle.Tile = 0 Then
                StretchBlt F.hDC, 0, 0, äirina, Visina, DeskHdc, mBack.X, mBack.Y, mBack.Width, mBack.Height, vbSrcCopy
            Else
    ...
    Select Case Stanje
        Case 0
            'Left Corner Up
            BitBlt F.hDC, uäirina, uVisina, mLeftCUP.Width, mLeftCUP.Height, DeskHdc, mLeftCUP.X, mLeftCUP.Y, vbSrcCopy
            uäirina = uäirina + mLeftCUP.Width
            ...
            'Title Left
            BitBlt F.hDC, uäirina, 0, mTitleLeft.Width, mTitleLeft.Height, DeskHdc, mTitleLeft.X, mTitleLeft.Y, vbSrcCopy
            uäirina = uäirina + mTitleLeft.Width
            lTitleLeft = uäirina * Screen.TwipsPerPixelX
            'PozadinaNaslova
            StretchBlt F.hDC, uäirina, 0, äirinaNaslova, mTitleBack.Height, DeskHdc, mTitleBack.X, mTitleBack.Y, mTitleBack.Width, mTitleBack.Height, vbSrcCopy
            uäirina = uäirina + äirinaNaslova
            'Kraj naslova
            BitBlt F.hDC, uäirina, 0, mTitleBackEnd.Width, mTitleBackEnd.Height, DeskHdc, mTitleBackEnd.X, mTitleBackEnd.Y, vbSrcCopy
            uäirina = uäirina + mTitleBackEnd.Width
            'TitleBar
            StretchBlt F.hDC, uäirina, 0, äirina - uäirina, mTitle.Height, DeskHdc, mTitle.X, mTitle.Y, mTitle.Width, mTitle.Height, vbSrcCopy
            'Close
            BitBlt F.hDC, äirina - (mClose.Width + mRightCUP.Width), 0, mClose.Width, mClose.Height, DeskHdc, mClose.X, mClose.Y, vbSrcCopy
            lCloseLeft = ((äirina - mClose.Width) * Screen.TwipsPerPixelX) - 40
            'Desni gornji ugao
            BitBlt F.hDC, äirina - mRightCUP.Width, 0, mRightCUP.Width, mRightCUP.Height, DeskHdc, mRightCUP.X, mRightCUP.Y, vbSrcCopy
            'Desna ivica
            StretchBlt F.hDC, äirina - mRight.Width, uVisina, mRight.Width, Visina - uVisina, DeskHdc, mRight.X, mRight.Y, mRight.Width, mRight.Height, vbSrcCopy
            'Donja linija
            StretchBlt F.hDC, mLeftCD.Width, Visina - mBottom.Height, äirina - (mLeftCD.Width + mRightCD.Width), mBottom.Height, DeskHdc, mBottom.X, mBottom.Y, mBottom.Width, mBottom.Height, vbSrcCopy
            'Donji Korner
            BitBlt F.hDC, äirina - mRightCD.Width, Visina - mRightCD.Height, mRightCD.Width, mRightCD.Height, DeskHdc, mRightCD.X, mRightCD.Y, vbSrcCopy
        Case 1
            'Left Corner Up
            BitBlt F.hDC, uäirina, uVisina, mLeftCUP.Width, mLeftCUP.Height, DeskHdc, mLeftCUP.X + mLeftCUP.Width, mLeftCUP.Y, vbSrcCopy
            uäirina = uäirina + mLeftCUP.Width
            uVisina = uVisina + mLeftCUP.Height
            'Left
            ...
            'Title Left
            BitBlt F.hDC, uäirina, 0, mTitleLeft.Width, mTitleLeft.Height, DeskHdc, mTitleLeft.X, mTitleLeft.Y + mTitleLeft.Height, vbSrcCopy
            uäirina = uäirina + mTitleLeft.Width
            lTitleLeft = uäirina * Screen.TwipsPerPixelX
            'PozadinaNaslova
            StretchBlt F.hDC, uäirina, 0, äirinaNaslova, mTitleBack.Height, DeskHdc, mTitleBack.X, mTitleBack.Y + mTitleBack.Height, mTitleBack.Width, mTitleBack.Height, vbSrcCopy
            uäirina = uäirina + äirinaNaslova
            'Kraj naslova
            BitBlt F.hDC, uäirina, 0, mTitleBackEnd.Width, mTitleBackEnd.Height, DeskHdc, mTitleBackEnd.X, mTitleBackEnd.Y + mTitleBackEnd.Height, vbSrcCopy
            uäirina = uäirina + mTitleBackEnd.Width
            'TitleBar
            StretchBlt F.hDC, uäirina, 0, äirina - uäirina, mTitle.Height, DeskHdc, mTitle.X, mTitle.Y + mTitle.Height, mTitle.Width, mTitle.Height, vbSrcCopy
            'Close
            BitBlt F.hDC, äirina - (mClose.Width + mRightCUP.Width), 0, mClose.Width, mClose.Height, DeskHdc, mClose.X, mClose.Y + mClose.Height, vbSrcCopy
            lCloseLeft = ((äirina - mClose.Width) * Screen.TwipsPerPixelX) - 40
            'Desni gornji ugao
            BitBlt F.hDC, äirina - mRightCUP.Width, 0, mRightCUP.Width, mRightCUP.Height, DeskHdc, mRightCUP.X + mRightCUP.Width, mRightCUP.Y, vbSrcCopy
            'Desna ivica
            StretchBlt F.hDC, äirina - mRight.Width, uVisina, mRight.Width, Visina - uVisina, DeskHdc, mRight.X + mRight.Width, mRight.Y, mRight.Width, mRight.Height, vbSrcCopy
            'Donja linija
            StretchBlt F.hDC, mLeftCD.Width, Visina - mBottom.Height, äirina - (mLeftCD.Width + mRightCD.Width), mBottom.Height, DeskHdc, mBottom.X, mBottom.Y + mBottom.Height, mBottom.Width, mBottom.Height, vbSrcCopy
            'Donji Korner
            BitBlt F.hDC, äirina - mRightCD.Width, Visina - mRightCD.Height, mRightCD.Width, mRightCD.Height, DeskHdc, mRightCD.X + mRightCD.Width, mRightCD.Y, vbSrcCopy
        End Select
    '
